...
function makeNimstrLit(c_65058) {
		  var ln = c_65058.length;
  var result = new Array(ln);
  for (var i = 0; i < ln; ++i) {
    result[i] = c_65058.charCodeAt(i);
  }
  return result;
...
function nimCopy(dest_66027, src_66028, ti_66029) {
	var result_66219 = null;

		switch (ti_66029.kind) {
		case 21:
		case 22:
		case 23:
		case 5:
			if (!(is_fat_pointer_66001(ti_66029))) {
			result_66219 = src_66028;
			}
			else {
				result_66219 = [src_66028[0], src_66028[1]];
			}
			
			break;
		case 19:
			      if (dest_66027 === null || dest_66027 === undefined) {
        dest_66027 = {};
      }
      else {
        for (var key in dest_66027) { delete dest_66027[key]; }
      }
      for (var key in src_66028) { dest_66027[key] = src_66028[key]; }
      result_66219 = dest_66027;
    
			break;
		case 18:
		case 17:
			if (!((ti_66029.base == null))) {
			result_66219 = nimCopy(dest_66027, src_66028, ti_66029.base);
			}
			else {
			if ((ti_66029.kind == 17)) {
			result_66219 = (dest_66027 === null || dest_66027 === undefined) ? {m_type: ti_66029} : dest_66027;
			}
			else {
				result_66219 = (dest_66027 === null || dest_66027 === undefined) ? {} : dest_66027;
			}
			}
			nimCopyAux(result_66219, src_66028, ti_66029.node);
			break;
		case 24:
		case 4:
		case 27:
        ...
        if (dest_66027 === null || dest_66027 === undefined) {
          dest_66027 = new Array(src_66028.length);
        }
        else {
          dest_66027.length = src_66028.length;
        }
        result_66219 = dest_66027;
        for (var i = 0; i < src_66028.length; ++i) {
          result_66219[i] = nimCopy(result_66219[i], src_66028[i], ti_66029.base);
        }
      }
		...
		case 28:
			      if (src_66028 !== null) {
        result_66219 = src_66028.slice(0);
      }
...
function arrayConstr(len_66286, value_66287, typ_66288) {
		    var result = new Array(len_66286);
    for (var i = 0; i < len_66286; ++i) result[i] = nimCopy(null, value_66287, typ_66288);
    return result;
...
function cstrToNimstr(c_65075) {
		  var ln = c_65075.length;
  var result = new Array(ln);
  var r = 0;
  for (var i = 0; i < ln; ++i) {
    var ch = c_65075.charCodeAt(i);
      ...
      if (ch < 2048) {
        ...
        if (ch < 55296 || ch >= 57344) {
          result[r] = (ch >> 12) | 224;
            ...
            ++i;
            ch = 65536 + (((ch & 1023) << 10) | (c_65075.charCodeAt(i) & 1023));
            result[r] = (ch >> 18) | 240;
            ++r;
...
function toJSStr(s_65092) {
		  if (s_65092 === null) return "";
  var len = s_65092.length;
  ...
  for (var i = 0; i < len; ++i) {
    if (nonAsciiPart !== null) {
      ...
      var code = s_65092[i].toString(16);
      if (code.length == 1) {
        code = "0"+code;
      }
      nonAsciiPart[offset] = "%";
    ...
    else if (s_65092[i] < 128)
      asciiPart[i] = fcc(s_65092[i]);
    else {
      asciiPart.length = i;
      nonAsciiOffset = i;
...
function addInt(a_65403, b_65404) {
		    var result = a_65403 + b_65404;
...
function chckIndx(i_66305, a_66306, b_66307) {
			var Tmp1;

	var result_66308 = 0;

	BeforeRet: do {
			if (!(a_66306 <= i_66305)) Tmp1 = false; else {				Tmp1 = (i_66305 <= b_66307);			}		if (Tmp1) {
		result_66308 = i_66305;
		break BeforeRet;
		}
		else {
		raiseIndexError(i_66305, a_66306, b_66307);
		}
...
function subInt(a_65421, b_65422) {
		    var result = a_65421 - b_65422;
    if (result > 2147483647 || result < -2147483648) raiseOverflow();
    return result;
...
function chckRange(i_66324, a_66325, b_66326) {
			var Tmp1;

	var result_66327 = 0;

	BeforeRet: do {
			if (!(a_66325 <= i_66324)) Tmp1 = false; else {				Tmp1 = (i_66324 <= b_66326);			}		if (Tmp1) {
		result_66327 = i_66324;
		break BeforeRet;
		}
		else {
		raiseRangeError();
...
function mulInt(a_65439, b_65440) {
		    var result = a_65439 * b_65440;
    if (result > 2147483647 || result < -2147483648) raiseOverflow();
    return result;
...
function nimMax(a_65758, b_65759) {
		var Tmp1;
...
function nimMin(a_65740, b_65741) {
		var Tmp1;
...
function is_fat_pointer_66001(ti_66003) {
	var result_66004 = false;

	BeforeRet: do {
		result_66004 = !((ConstSet1[ti_66003.base.kind] != undefined));
		break BeforeRet;
	} while (false);
...
function nimCopyAux(dest_66032, src_66033, n_66035) {
		switch (n_66035.kind) {
		case 0:
			break;
		case 1:
			      dest_66032[n_66035.offset] = nimCopy(dest_66032[n_66035.offset], src_66033[n_66035.offset], n_66035.typ);
    
			break;
		case 2:
			    for (var i = 0; i < n_66035.sons.length; i++) {
      nimCopyAux(dest_66032, src_66033, n_66035.sons[i]);
    }
		...
		case 3:
			      dest_66032[n_66035.offset] = nimCopy(dest_66032[n_66035.offset], src_66033[n_66035.offset], n_66035.typ);
      for (var i = 0; i < n_66035.sons.length; ++i) {
        nimCopyAux(dest_66032, src_66033, n_66035.sons[i][1]);
      }
...
function raiseIndexError(i_64643, a_64644, b_64645) {
		var e_64649 = null;
		e_64649 = {m_type: NTI46858, parent: null, name: null, message: null, trace: null, raiseId: 0, up: null};
		e_64649.message = nimCopy(null, (makeNimstrLit("index ") || []).concat(cstrToNimstr((i_64643)+"") || [],makeNimstrLit(" not in ") || [],cstrToNimstr((a_64644)+"") || [],makeNimstrLit(" .. ") || [],cstrToNimstr((b_64645)+"") || []), NTI43040);
		e_64649.parent = null;
		raiseException(e_64649, "IndexError");
